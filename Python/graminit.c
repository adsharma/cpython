...
static const arc arcs_93_0[1] = {
    {186, 1},
};
static const arc arcs_93_1[2] = {
    {45, 2},
    {2, 1},
};
...
static const arc arcs_94_0[1] = {
    {5, 1},
};
static const arc arcs_94_1[2] = {
    {62, 2},
    {187, 3},
};
static const arc arcs_94_2[1] = {
    {57, 4},
};
static const arc arcs_94_3[1] = {
    {62, 2},
};
static const arc arcs_94_4[1] = {
    {59, 5},
};
static const arc arcs_94_5[1] = {
    {0, 5},
};
static state states_94[6] = {
    {1, arcs_94_0},
    {2, arcs_94_1},
    {1, arcs_94_2},
    {1, arcs_94_3},
...
static const arc arcs_95_0[3] = {
    {6, 1},
    {64, 2},
    {59, 3},
};
static const arc arcs_95_1[3] = {
    {66, 4},
    {59, 5},
    {0, 1},
};
static const arc arcs_95_2[1] = {
    {59, 6},
};
static const arc arcs_95_3[2] = {
    {66, 7},
    {0, 3},
};
static const arc arcs_95_4[2] = {
    {64, 2},
    {59, 5},
};
static const arc arcs_95_5[2] = {
    {66, 4},
    {0, 5},
};
static const arc arcs_95_6[1] = {
    {0, 6},
};
static const arc arcs_95_7[4] = {
    {6, 8},
    {64, 2},
    {59, 3},
    {0, 7},
};
static const arc arcs_95_8[3] = {
    {66, 9},
    {59, 10},
    {0, 8},
};
static const arc arcs_95_9[2] = {
    {64, 2},
    {59, 10},
};
static const arc arcs_95_10[2] = {
    {66, 9},
    {0, 10},
};
static state states_95[11] = {
    {3, arcs_95_0},
    {3, arcs_95_1},
    {1, arcs_95_2},
    {2, arcs_95_3},
...
static const dfa dfas[96] = {
    ...
    {258, "eval_input", 3, states_2,
     "\240\173\000\124\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    ...
    {272, "expr_stmt", 6, states_16,
     "\340\173\000\124\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    ...
    {310, "or_test", 2, states_54,
     "\240\173\000\120\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {311, "and_test", 2, states_55,
     "\240\173\000\120\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {312, "not_test", 3, states_56,
     "\240\173\000\120\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {313, "comparison", 2, states_57,
     "\240\173\000\100\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    ...
    {323, "power", 4, states_67,
     "\040\172\000\100\040\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {324, "atom_expr", 4, states_68,
     "\040\172\000\100\040\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    ...
    {328, "subscriptlist", 3, states_72,
     "\240\173\000\124\140\017\000\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {329, "subscript", 5, states_73,
     "\240\173\000\124\140\017\000\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {330, "sliceop", 3, states_74,
     "\000\000\000\000\000\000\000\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {331, "exprlist", 3, states_75,
     "\340\173\000\100\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {332, "testlist", 3, states_76,
     "\240\173\000\124\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {333, "dictorsetmaker", 14, states_77,
     "\340\173\000\124\140\017\000\000\001\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    ...
    {343, "yield_arg", 3, states_87,
     "\340\173\100\124\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {344, "pmatch_stmt", 2, states_88,
     "\000\000\000\100\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {345, "pmatch_expr", 5, states_89,
     "\000\000\000\100\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {346, "pmatch_body", 7, states_90,
     "\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {347, "pmatch_case", 4, states_91,
     "\340\173\000\124\140\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {348, "func_body_suite", 7, states_92,
     "\344\373\325\376\161\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {349, "func_type_input", 3, states_93,
     "\040\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {350, "func_type", 6, states_94,
     "\040\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
    {351, "typelist", 11, states_95,
     "\340\173\000\124\140\017\000\000\001\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"},
};
static const label labels[188] = {
    {0, "EMPTY"},
    {256, 0},
    {4, 0},
    {295, 0},
